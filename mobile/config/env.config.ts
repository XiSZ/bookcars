 ...
 * @type {number}
 */
export const CARS_PAGE_SIZE: number =
  Number.parseInt(BC_CARS_PAGE_SIZE, 10) || 8;
 ...
 * @type {number}
 */
export const BOOKINGS_PAGE_SIZE: number =
  Number.parseInt(BC_BOOKINGS_PAGE_SIZE, 10) || 8;
 ...
 * @type {number}
 */
export const SUPPLIER_IMAGE_WIDTH: number =
  Number.parseInt(BC_SUPPLIER_IMAGE_WIDTH, 10) || 60;
 ...
 * @type {number}
 */
export const SUPPLIER_IMAGE_HEIGHT: number =
  Number.parseInt(BC_SUPPLIER_IMAGE_HEIGHT, 10) || 30;
 ...
 * @type {number}
 */
export const CAR_IMAGE_WIDTH: number =
  Number.parseInt(BC_CAR_IMAGE_WIDTH, 10) || 300;
 ...
 * @type {number}
 */
export const CAR_IMAGE_HEIGHT: number =
  Number.parseInt(BC_CAR_IMAGE_HEIGHT, 10) || 200;
