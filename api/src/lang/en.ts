export const en = {
  ...
  ACCOUNT_ACTIVATION_TECHNICAL_ISSUE:
    "Technical Issue! Please click on resend to validate your email.",
  ACCOUNT_ACTIVATION_LINK_EXPIRED:
    "Your validation link may have expired. Please click on resend to validate your email.",
  ...
  ACCOUNT_ACTIVATION_EMAIL_SENT_PART_2:
    ". It will be expire after one day. If you didn't receive validation email click on resend.",
  ...
  BOOKING_CONFIRMED_PART2:
    "is confirmed and the payment was successfully done.",
  ...
  BOOKING_CONFIRMED_PART8:
    "Please bring your ID, driver's license and warranty check with you.",
  ...
  BOOKING_CONFIRMED_PART13:
    "Please respect the pick-up and drop-off dates and times.",
