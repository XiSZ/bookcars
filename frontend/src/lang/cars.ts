...
const strings = new LocalizedStrings({
  ...
  de: {
    ...
    TITLE_1: "Auto ",
    TITLE_2: " für Sie",
    TITLE_CAR_AVAILABLE: "verfügbares Auto",
    TITLE_CARS_AVAILABLE: "verfügbare Autos",
  },
  es: {
    NEW_CAR: "Coche nuevo",
    ...
    GEARBOX_AUTOMATIC_TOOLTIP:
      "Este coche tiene una caja de cambios automática",
    ...
    FUEL_POLICY_LIKE_FOR_LIKE_TOOLTIP:
      "Este coche se entrega con combustible y debe ser devuelto con la misma cantidad.",
    FUEL_POLICY_FREE_TANK_TOOLTIP:
    ...
    COLLISION_DAMAGE_WAVER_TOOLTIP:
      "El alquiler puede incluir una renuncia por daños por colisión.",
    FULL_INSURANCE: "Seguro a todo riesgo",
    FULL_INSURANCE_TOOLTIP:
      "El alquiler puede incluir renuncia por colisión y protección contra robo del vehículo.",
    ...
    LESS_THAN_VALUE_1: `Menos de ${isUS ? env.CURRENCY : ""}${
      env.DEPOSIT_FILTER_VALUE_1
    }${!isUS ? ` ${env.CURRENCY}` : ""}`,
    LESS_THAN_VALUE_2: `Menos de ${isUS ? env.CURRENCY : ""}${
      env.DEPOSIT_FILTER_VALUE_2
    }${!isUS ? ` ${env.CURRENCY}` : ""}`,
    LESS_THAN_VALUE_3: `Menos de ${isUS ? env.CURRENCY : ""}${
      env.DEPOSIT_FILTER_VALUE_3
    }${!isUS ? ` ${env.CURRENCY}` : ""}`,
    TRIPS: "viajes",
    CO2: "Efecto CO2",
